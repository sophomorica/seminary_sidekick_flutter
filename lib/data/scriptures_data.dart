...
final List<Scripture> allScriptures = [
  ...
  Scripture(
      ...
      verses: ['For behold, this is my work and my glory—to bring to pass the immortality and eternal life of man.'],
  ),
  Scripture(
      id: '2',
      book: ScriptureBook.oldTestament,
      ...
      verses: ['And the Lord called his people Zion, because they were of one heart and one mind, and dwelt in righteousness; and there was no poor among them.'],
  ),
  Scripture(
      id: '3',
      book: ScriptureBook.oldTestament,
  ...
  Scripture(
      ...
      verses: ['Therefore shall a man leave his father and his mother, and shall cleave unto his wife: and they shall be one flesh.'],
  ),
  Scripture(
      id: '7',
      book: ScriptureBook.oldTestament,
      ...
      verses: ['There is none greater in this house than I; neither hath he kept back any thing from me but thee, because thou art his wife: how then can I do this great wickedness, and sin against God?'],
  ),
  Scripture(
      id: '8',
      book: ScriptureBook.oldTestament,
  ...
  Scripture(
      ...
      verses: ['And if it seem evil unto you to serve the Lord, choose you this day whom ye will serve; whether the gods which your fathers served that were on the other side of the flood, or the gods of the Amorites, in whose land ye dwell: but as for me and my house, we will serve the Lord.'],
  ),
  Scripture(
      id: '10',
      book: ScriptureBook.oldTestament,
  ...
  Scripture(
      ...
      verses: ['Come now, and let us reason together, saith the Lord: though your sins be as scarlet, they shall be as white as snow; though they be red like crimson, they shall be as wool.'],
  ),
  Scripture(
      id: '13',
      book: ScriptureBook.oldTestament,
      ...
      verses: ['Woe unto them that call evil good, and good evil; that put darkness for light, and light for darkness; that put bitter for sweet, and sweet for bitter!'],
  ),
  Scripture(
      id: '14',
      book: ScriptureBook.oldTestament,
  ...
  Scripture(
      ...
      verses: ['Surely the Lord God will do nothing, but he revealeth his secret unto his servants the prophets.'],
  ),
  Scripture(
      id: '23',
      book: ScriptureBook.oldTestament,
  ...
  Scripture(
      ...
      verses: ['Jesus answered, Verily, verily, I say unto thee, Except a man be born of water and of the Spirit, he cannot enter into the kingdom of God.'],
  ),
  Scripture(
      id: '33',
      book: ScriptureBook.newTestament,
  ...
  Scripture(
      ...
      verses: ['If any man will do his will, he shall know of the doctrine, whether it be of God, or whether I speak of myself.'],
  ),
  Scripture(
      id: '35',
      book: ScriptureBook.newTestament,
      ...
      verses: ['And this is life eternal, that they might know thee the only true God, and Jesus Christ, whom thou hast sent.'],
  ),
  Scripture(
      id: '36',
      book: ScriptureBook.newTestament,
  ...
  Scripture(
      ...
      verses: ['Nevertheless neither is the man without the woman, neither the woman without the man, in the Lord.'],
  ),
  Scripture(
      id: '38',
      book: ScriptureBook.newTestament,
  ...
  Scripture(
      ...
      verses: ['That in the dispensation of the fulness of times he might gather together in one all things in Christ, both which are in heaven, and which are on earth; even in him.'],
  ),
  Scripture(
      id: '41',
      book: ScriptureBook.newTestament,
  ...
  Scripture(
      ...
      verses: ['Furthermore we have had fathers of our flesh which corrected us, and we gave them reverence: shall we not much rather be in subjection unto the Father of spirits, and live?'],
  ),
  Scripture(
      id: '45',
      book: ScriptureBook.newTestament,
  ...
  Scripture(
      ...
      verses: ['For for this cause was the gospel preached also to them that are dead, that they might be judged according to men in the flesh, but live according to God in the spirit.'],
  ),
  Scripture(
      id: '48',
      book: ScriptureBook.newTestament,
      ...
      verses: ['And I saw the dead, small and great, stand before God; and the books were opened: and another book was opened, which is the book of life: and the dead were judged out of those things which were written in the books, according to their works.'],
  ),
  ...
  Scripture(
      ...
      verses: ['And it came to pass that I, Nephi, said unto my father: I will go and do the things which the Lord hath commanded, for I know that the Lord giveth no commandments unto the children of men, save he shall prepare a way for them that they may accomplish the thing which he commandeth them.'],
  ),
  Scripture(
      id: '50',
      book: ScriptureBook.bookOfMormon,
      ...
      fullText:
          'Adam fell that men might be; and men are, that they might have joy.',
      verses: ['Adam fell that men might be; and men are, that they might have joy.'],
  ),
  Scripture(
      id: '51',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['Angels speak by the power of the Holy Ghost; wherefore, they speak the words of Christ. Wherefore, I said unto you, feast upon the words of Christ; for behold, the words of Christ will tell you all things what ye should do.'],
  ),
  Scripture(
      id: '55',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['And behold, I tell you these things that ye may learn wisdom; that ye may learn that when ye are in the service of your fellow beings ye are only in the service of your God.'],
  ),
  Scripture(
      id: '57',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['Believe in God; believe that he is, and that he created all things, both in heaven and in earth; believe that he has all wisdom, and all power, both in heaven and in earth; believe that man doth not comprehend all the things which the Lord can comprehend.'],
  ),
  Scripture(
      id: '60',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['Now my son, I would that ye should repent and forsake your sins, and go no more after the lusts of your eyes, but cross yourself in all these things; for except ye do this ye can in nowise inherit the kingdom of God. Oh, remember, and take it upon you, and cross yourself in these things.'],
  ),
  Scripture(
      id: '64',
      book: ScriptureBook.bookOfMormon,
      ...
      verses: ['Do not suppose, because it has been spoken concerning restoration, that ye shall be restored from sin to happiness. Behold, I say unto you, wickedness never was happiness.'],
  ),
  Scripture(
      id: '65',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['Therefore I would that ye should be perfect even as I, or your Father who is in heaven is perfect.'],
  ),
  Scripture(
      id: '68',
      book: ScriptureBook.bookOfMormon,
      ...
      verses: ['Now this is the commandment: Repent, all ye ends of the earth, and come unto me and be baptized in my name, that ye may be sanctified by the reception of the Holy Ghost, that ye may stand spotless before me at the last day.'],
  ),
  Scripture(
      id: '69',
      book: ScriptureBook.bookOfMormon,
      ...
      verses: ['And now, I, Moroni, would speak somewhat concerning these things; I would show unto the world that faith is things which are hoped for and not seen; wherefore, dispute not because ye see not, for ye receive no witness until after the trial of your faith.'],
  ),
  Scripture(
      id: '70',
      book: ScriptureBook.bookOfMormon,
  ...
  Scripture(
      ...
      verses: ['Look unto me in every thought; doubt not, fear not.'],
  ),
  Scripture(
      id: '77',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      verses: ['Remember the worth of souls is great in the sight of God.'],
  ),
  Scripture(
      id: '80',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      // CANON_DIFF: wording/punctuation differs from LDS canon for verse(s) [10] (split-only; app fullText unchanged).
  ),
  Scripture(
      id: '84',
      book: ScriptureBook.doctrineAndCovenants,
      ...
      verses: ['And again, verily I say unto you, that whoso forbiddeth to marry is not ordained of God, for marriage is ordained of God unto man.'],
  ),
  Scripture(
      id: '85',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      verses: ['I, the Lord, am bound when ye do what I say; but when ye do not what I say, ye have no promise.'],
  ),
  Scripture(
      id: '89',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      verses: ['And as all have not faith, seek ye diligently and teach one another words of wisdom; yea, seek ye out of the best books words of wisdom; seek learning, even by study and also by faith.'],
  ),
  Scripture(
      id: '91',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      // CANON_DIFF: third segment is not D&C 107:20 (Aaronic); app corpus continues Melchizedek material.
  ),
  Scripture(
      id: '93',
      book: ScriptureBook.doctrineAndCovenants,
  ...
  Scripture(
      ...
      verses: ['Joseph Smith, the Prophet and Seer of the Lord, has done more, save Jesus only, for the salvation of men in this world, than any other man that ever lived in it. In the short space of twenty years, he has brought forth the Book of Mormon, which he translated by the gift and power of God, and has been the means of publishing it on two continents; has sent the fulness of the everlasting gospel, which it contained, to the four quarters of the earth; has brought forth the revelations and commandments which compose this book of Doctrine and Covenants, and many other wise documents and instructions for the benefit of the children of men; gathered many thousands of the Latter-day Saints, founded a great city, and left a fame and name that cannot be slain. He lived great, and he died great in the eyes of God and his people; and like most of the Lord\'s anointed in ancient times, has sealed his mission and his works with his own blood; and so has his brother Hyrum. In life they were not divided, and in death they were not separated!'],
  ), // Missing Doctrine and Covenants passages (IDs 97–100 from official 2023 Core Document)
  Scripture(
    id: '97',
    book: ScriptureBook.doctrineAndCovenants,
    volume: 'D&C',
  ...
  Scripture(
    ...
    fullText:
      ...
      verses: ['Verily, thus saith the Lord: It shall come to pass that every soul who forsaketh his sins and cometh unto me, and calleth on my name, and obeyeth my voice, and keepeth my commandments, shall see my face and know that I am;'],
  ),
  Scripture(
    id: '99',
    book: ScriptureBook.doctrineAndCovenants,
    ...
    fullText:
      ...
      // CANON_DIFF: wording/punctuation differs from LDS canon for verse(s) [20] (split-only; app fullText unchanged).
  ),
  Scripture(
    id: '100',
    book: ScriptureBook.doctrineAndCovenants,
    ...
    fullText:
      ...
      verses: [
        'As I searched the scriptures, I came to the vision of the redemption of the dead; And I saw the hosts of the dead, both small and great. ... ',
        'Thus was it made known that our Redeemer spent his time in the world of spirits instructing the faithful spirits who had departed mortality in the way of salvation, teaching them the plan of redemption which had been prepared from the foundation of the world; that through his atonement the great plan of salvation might be accomplished; that they might receive the fulness of joy in the mansions of his Father.',
      ],
      // CANON_DIFF: abridged passage (ellipsis); verse gates follow app text segments, not full canon wording.
  ),
