...
- **acceptance_criteria**:
  - [x] Master: nothing judged mid-word; space/done commits; autocorrect rewrites ("cjeck" → "check ") pass the single-word formatter and commit cleanly
  ...
  - [x] Final word auto-commits without a trailing space
